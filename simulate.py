...
# 参数输入
st.title('制导Demo')
max_simulate_time = st.sidebar.slider('仿真时长', min_value=5, max_value=200, value=100)
speed = st.sidebar.slider('速度', min_value=50, max_value=500, value=200)
Ns = st.sidebar.multiselect("N", [1, 2, 3, 4, 5], [3, 4, 5])
x0 = st.sidebar.number_input("x0 (m)", -2000)
y0 = st.sidebar.number_input("y0 (m)", 2000)
gamma0 = st.sidebar.number_input("gamma0 (deg)", 45)
